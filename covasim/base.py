    ...
    def update_pars(self, pars=None, create=False, **kwargs):
        ...
        if pars:
            ...
            if pars.get('pop_type'):
                cvpar.GenParsBuilder.reset_layer_pars(pars, force=False)
            if pars.get('prog_by_age'):
                pars['prognoses'] = cvpar.GenParsBuilder.get_prognoses(by_age=pars['prog_by_age'], version=self._default_ver) # Reset prognoses
