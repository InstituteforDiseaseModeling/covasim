...
def make_hspars():
    ...
    hsp.symptomatic  = 0.5  # Fraction of cases that are symptomatic -- DONE
    hsp.hospitalized = 0.25 # Fraction of sympotmatic cases that require hospitalization -- DONE
    hsp.icu          = 0.08 # Fraction of symptomatic cases that require ICU -- TODO
    ...
    hsp.delay        = 5    # Days between being infected and being hospitalized -- DONE
