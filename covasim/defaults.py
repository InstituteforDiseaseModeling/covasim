...
class PeopleMeta(sc.prettyobj):
    ...
    def __init__(self):
        ...
        # Neutralizing antibody states, by variant/vaccine
        self.nab_by_source_states = [
            'peak_nab',  # Float, peak neutralization titre relative to convalescent plasma
            'nab',  # Float, current neutralization titre relative to convalescent plasma
            'time_of_boost',  # Float, time since nab-conferring event
        ]
        ...
        self.all_states = self.person + self.states + self.variant_states + self.by_variant_states + self.imm_states + self.nab_states + self.nab_by_source_states + self.vacc_states + self.dates + self.durs

        # Validate
        self.state_types = ['person', 'states', 'variant_states', 'by_variant_states', 'imm_states', 'nab_states',
                            'nab_by_source_states', 'vacc_states', 'dates', 'durs', 'all_states']
