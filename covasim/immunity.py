    ...
    **Example**::
    ...
    def parse(self, variant=None, label=None):
        ...
        if isinstance(variant, str):
            ...
            choices, mapping = cvpar.variantPars.get_variant_choices()
            known_variant_pars = cvpar.variantPars.get_variant_pars()
        ...
        # Option 2: variants can be specified as a dict of pars
            ...
            default_variant_pars = cvpar.variantPars.get_variant_pars(default=True)
...
def init_immunity(sim, create=False):
    ...
    if sim['immunity'] is None or create:
        ...
        default_cross_immunity = cvpar.immunityPars.get_cross_immunity()
        for i in range(ns):
