...
class Sim(cvb.BaseSim):
    ...
    **Examples**::
    ...
    def reset_layer_pars(self, layer_keys=None, force=False):
        ...
        cvpar.Parameters.reset_layer_pars(self.pars, layer_keys=layer_keys, force=force)
        return
    ...
    def validate_layer_pars(self):
        ...
        layer_pars = cvpar.Parameters.layer_pars # The names of the parameters that are specified by layer
