...
def make_pars():
    ...
    pars['scale']      = 5000 # Factor by which to scale results -- assume half of US population

    pars['n']          = 32.7e3 # Number ultimately susceptible to CoV
    pars['n_infected'] = 5 # Number of seed cases
    pars['day_0']      = datetime(2020, 2, 21)  #datetime(2020, 2, 10) # Start day of the epidemic 3/5
    pars['n_days']     = 180 # 50 # 25 for calibration, 50 for projections # How many days to simulate
