...
class BaseVaccination(Intervention):
    ...
    def _parse_vaccine_pars(self, vaccine=None, label=None):
        ...
        if isinstance(vaccine, str):
            ...
            choices, mapping = cvpar.vaccinePars.get_vaccine_choices()
            variant_pars = cvpar.vaccinePars.get_vaccine_variant_pars()
            dose_pars = cvpar.vaccinePars.get_vaccine_dose_pars()
    ...
    def initialize(self, sim):
        ...
        default_variant_pars = cvpar.vaccinePars.get_vaccine_variant_pars(default=True)
        default_dose_pars   = cvpar.vaccinePars.get_vaccine_dose_pars(default=True)
