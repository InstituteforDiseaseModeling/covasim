...
def make_pars(set_prognoses=False, prog_by_age=True, **kwargs):
    ...
    pars['beta_dist']   = {'dist':'neg_binomial','par1':1.0, 'par2':0.45} # Distribution to draw individual level transmissibility; dispersion from https://www.researchsquare.com/article/rs-29548/v1
