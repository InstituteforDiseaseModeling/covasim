...
def get_prognoses(by_age=True):
    ...
    if not by_age:
        ...
        prognoses = dict(
            ...
            symp_probs   = np.array([0.20,    0.30,    0.40,    0.50,    0.60,    0.70,    0.70,    0.80,    0.90]),    # Overall probability of developing symptoms (https://www.medrxiv.org/content/10.1101/2020.03.24.20043018v1.full.pdf)
