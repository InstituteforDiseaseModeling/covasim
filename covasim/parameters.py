...
def make_pars(set_prognoses=False, prog_by_age=True, **kwargs):
    ...
    pars['beta_dist']   = {'dist':'neg_binomial','par1':0.84, 'par2':1.0} # Distribution to draw individual level transmissibility; see https://wellcomeopenresearch.org/articles/5-67
