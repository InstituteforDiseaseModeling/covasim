...
def make_pars(set_prognoses=False, prog_by_age=True, version=None, **kwargs):
    ...
    pars['nab_decay']       = dict(form='nab_growth_decay', growth_time=22, decay_rate1=0.003537646, decay_rate2=0.002587529)
...
def get_vaccine_dose_pars(default=False):
    ...
    pars = dict(
        ...
        default = dict(
            nab_eff   = dict(alpha_inf=1.11, beta_inf=1.219, alpha_symp_inf=-1.06, beta_symp_inf=0.867,
