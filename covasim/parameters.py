...
def make_pars(set_prognoses=False, prog_by_age=True, **kwargs):
    ...
    pars['beta_dist']   = {'dist':'negbinom','par1':0.84, 'par2':0.45} # Distribution to draw individual level transmissibility; use 'neg_binomial' instead of 'lognormal' for more overdispersion; see https://wellcomeopenresearch.org/articles/5-67
