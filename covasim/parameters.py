...
def make_pars(set_prognoses=False, prog_by_age=True, version=None, **kwargs):
    ...
    pars['use_immunity']            = False # Whether to use dynamically calculated immunity
    ...
    pars['NAb_eff']                 = {'sus': {'slope': 2.7, 'n_50': 0.03}, 'symp': 0.1, 'sev': 0.52} # Parameters to map NAbs to efficacy
    ...
    pars['rel_imm']['asymptomatic'] = 0.85
    pars['rel_imm']['mild']         = 1
