...
if __name__ == '__main__':
    ...
    people = cv.make_synthpop(sim=sim, max_contacts=None, generate=None, with_industry_code=False, with_facilities=False,
    ...
    filepath = sc.makefilepath(filename='testPop.pop')
